...
public class GED
{
    ...
    public static GameEventDispatcher ReqED = new GameEventDispatcher(); 
    public static GameEventDispatcher ResED = new GameEventDispatcher(); 
    public static GameEventDispatcher GuideED = new GameEventDispatcher(); 
}